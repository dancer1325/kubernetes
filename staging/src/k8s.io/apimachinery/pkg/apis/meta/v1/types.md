...
* == metadata / ALL Kubernetes objects MUST have
...
* ``ManagedFields []ManagedFieldsEntry `json:"managedFields,omitempty" protobuf:"bytes,17,rep,name=managedFields"``
  * OPTIONAL
  * [workflow-id & version, set of fields / managed -- by -- that workflow]
    * set of fields' version == version | workflow was modifying the object 
  * use case
    * internal
      * != users of Kubernetes
  * workflow
...
* == workflow-id + FieldSet + resource's group version / fieldset applies to 
