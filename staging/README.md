...
* goal
  * 💡packages / have been split -- to -- their own repository💡
    * ⚠️content here is periodically published -- to -- their own repository⚠️

* current repositories / staged here
...
## how to contribute (issues, PR, ...)?
* | 👀[main Kubernetes repository](https://github.com/kubernetes/kubernetes)👀
  * == here

## how to use staged repositories -- from -- Kubernetes code?

* TODO: Kubernetes code uses the repositories in this directory via a Go workspace and
